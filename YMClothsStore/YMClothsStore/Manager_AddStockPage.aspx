<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manager_AddStockPage.aspx.cs" Inherits="YMClothsStore.Manager_AddStockPage" %>
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container addstaff-form" style="width:50%;">
      <!-- form在这里！ -->
      <form runat="server">
        <!-- 输入补货产品id name:clothesId -->
        <div class="form-group">
          <div class="row">
            <div class="col-sm-2 name-offset col-sm-offset-3">
              <label class="control-label text-right">补货产品ID：</label>
            </div>
            <div class="col-sm-5">
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-sm-2 name-offset col-sm-offset-3">
              <label class="control-label text-right">补货量：</label>
            </div>
            <div class="col-sm-5">
