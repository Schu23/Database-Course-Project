          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-left">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="~/Manager_clothesInfo.aspx" runat="server">查询服装信息</a></li>
              ...
              <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a href="~/Manager_AddOrder.aspx" runat="server">增加订单</a></li>
                </ul>
              </li>
              <li class="dropdown">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="~/Manager_StaffInfo.aspx" runat="server">查看/修改员工信息</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="text-center"><a href="~/ChangeSelfInfo.aspx" runat="server">修改个人信息</a></li>
                  <li class="text-center"><a href="~/Login.aspx" runat ="server">退出</a></li>
                </ul>
              </li>
            </ul>
          </div><!-- /.navbar-collapse -->
